...
Current test beta: **0.1.0-beta.2**. Windows x64, Intel Mac and Apple Silicon archives are attached to the corresponding release. These are early test releases, not a production-readiness or warning-free-installation claim.
